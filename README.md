# picojs
[![Build Status](https://github.com/picoio/picojs/workflows/CI/badge.svg?branch=master)](https://github.com/PICOIO/picojs/actions)  [![npm version](https://badge.fury.io/js/picojs.svg)](https://badge.fury.io/js/picojs)  [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)  ![npm](https://img.shields.io/npm/dw/picojs.svg)

Javascript API for integration with PICOIO-based blockchains using [PICOIO RPC API](https://developers.pico.io/picoio-nodpico/reference).

Documentation can be found [here](https://picoio.github.io/picojs)

## Installation

### NPM

The official distribution package can be found at [npm](https://www.npmjs.com/package/picojs).
...
```js
import { Api, JsonRpc, RpcError } from 'picojs';
...
```js
const { Api, JsonRpc, RpcError } = require('picojs');
const { JsSignatureProvider } = require('picojs/dist/picojs-jssig');      // development only
