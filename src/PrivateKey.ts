...
import { constructElliptic, PublicKey, Signature } from './picojs-key-conversions';
...
export class PrivateKey {
    ...
    /** Instantiate private key from an PICOIO-format private key */
    ...
    /** Export private key as PICOIO-format private key */
