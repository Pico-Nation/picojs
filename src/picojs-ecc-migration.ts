import {PrivateKey, PublicKey, Signature} from './picojs-jssig';
import {generateKeyPair} from './picojs-key-conversions';
...
export const ecc = {
    ...
    sha256: (data: string|Buffer, resultEncoding?: string, encoding?: string): string|Buffer => {
        ...
        return require('./picojs-key-conversions').sha256(data);
    }
};
