...
import * as numeric from './picojs-numeric';
import { Abi, BlockTaposInfo, BlockHeaderStateTaposInfo } from './picojs-rpc-interfaces';
...
export const supportedAbiVersion = (version: string) => {
    return version.startsWith('picoio::abi/1.');
};
