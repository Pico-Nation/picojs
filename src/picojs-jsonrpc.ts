 ...
 * @module JSON-RPC
 */
// copyright defined in picojs/LICENSE.txt

import { AbiProvider, AuthorityProvider, AuthorityProviderArgs, BinaryAbi } from './picojs-api-interfaces';
import { base64ToBinary, convertLegacyPublicKeys } from './picojs-numeric';
import {
    GetAbiResult,
    GetBlockResult,
    GetCodeResult,
