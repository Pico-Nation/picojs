...
const { JsSignatureProvider } = require('../../dist/picojs-jssig');
...
/* new accounts for testing can be created by unlocking a clpico wallet then calling:
 * 1) clpico create key --to-console (copy this privateKey & publicKey)
 * 2) clpico wallet import
 * 3) clpico create account bob publicKey
 * 4) clpico create account alice publicKey
 */
