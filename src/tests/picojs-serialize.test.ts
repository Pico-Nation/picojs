...
import { createInitialTypes, Type, SerialBuffer } from '../picojs-serialize';
...
describe('Serialize', () => {
    ...
    describe('pushAsset', () => {
        ...
        it('should be able to push asset with valid PICO symbol "10.000 PICO"', () => {
            const asset = '10.000 PICO';
        ...
        it('should not be able to push invalid lowercase symbol "10.000 pico"', () => {
            const asset = '10.000 pico';

            expectExceptionThrown(asset);
        });

        it('should not be able to push two symbols "10.000 PICO blah"', () => {
            const asset = '10.000 PICO blah';
