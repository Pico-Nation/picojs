...
import { Api } from '../picojs-api';
import { JsonRpc } from '../picojs-jsonrpc';
import { JsSignatureProvider } from '../picojs-jssig';
...
describe('picojs-api', () => {
    ...
    it('getAbi returns an abi', async () => {
        const response = await api.getAbi('testpicotoken');
    ...
    it('getContract returns a contract', async () => {
        const response = await api.getContract('testpicotoken');
    ...
    it('rawAbiToJson returns correct Json from raw Abi', async () => {
        const expected = await api.getAbi('testpicotoken');
        const response = await rpc.getRawAbi('testpicotoken');
    ...
    it('jsonToRawAbi returns correct raw Abi from Json', async () => {
        ...
        const jsonAbi = await api.getAbi('testpicotoken');
    ...
    it('confirms jsonToRawAbi and rawAbiToJson are reciprocal', async () => {
        const expectedJsonAbi = await api.getAbi('testpicotoken');
        const response = await rpc.getRawAbi('testpicotoken');
