As stated in the [introduction](index.md), `picojs` integrates with PICOIO-based blockchains using the [PICOIO Nodpico RPC API](https://developers.pico.io/picoio-nodpico/reference).
